...
<html lang="fr">
    <head>
        ...
        <link rel="icon" href="img/LogoVal.jpg">
        <!-- From GSAP Librairy -->
...
<main>
    <section class="landing">
        ...
        <nav class="nav" id="navb">
            ...
            <!-- BURGER POUR UN MENU RESPONSIVE -->
            <div class="burger">
               <div class="line1"></div>
               <div class="line2"></div>
               <div class="line3"></div>
            ...
            <!-- PAGE D'ACCUEIL SCROLLING -->
           <div id="fullpage">
                <!-- SECTION 1 BANNIERE + TITLE + CTA-->
               ...
               <!-- SECTION 2  TITLE + MINI PRESENTATION + CTA-->
                <section class="section s2">
                    <h1>NOUS SOMMES A VOTRE DISPOSITION</h1>
                    <div class="description">
                        <p>Vous-êtes Artiste, Solopreneur ou artisan, vous gérez votre communication  seul depuis un
                            moment  et vous voulez être plus performant ? Vous êtes au bon endroit, V-DESIgN vous
                            apporte le soutien dont vous avez besoin, n'hésitez pas à nous
                            <a href="">contacter.</a>
                        </p>
                    </div>
                    ...
                    <img  src="img/pexels-karolina-grabowska-5311526.jpg" class="pic" alt="">
                   <img  src="img/pexels-jennifer-enujiugha-4166353.jpg" alt="" class="pic">
                    <img src="img/pexels-anthony-shkraba-4348078.jpg" class="pic" alt="">
                </section>
           </div>
    </section>
</main>
